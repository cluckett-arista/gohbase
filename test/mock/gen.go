...
//go:generate mockgen -destination=call.go -package=mock gohbase/hrpc Call
//go:generate mockgen -destination=zk/client.go -package=mock gohbase/zk Client
//go:generate mockgen -destination=region/client.go -package=mock gohbase/hrpc RegionClient
